...
public class LGRenderNetherStarBlock extends TileEntitySpecialRenderer<LGTileEntityNetherStarBlock>
{
    private static final ResourceLocation TEXTURE = new ResourceLocation("legendgear:textures/misc/nether_star.png");

    @Override
    public void render(LGTileEntityNetherStarBlock entity, double x, double y, double z, float partialTicks, int destroyStage, float alpha)
    {
