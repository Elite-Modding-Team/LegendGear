...
public enum LGSoundEvents
{
    ...
    ITEM_SPELL_CHARGE("item.spell.charge"),
    ITEM_SPELL_CRITICAL("item.spell.critical"),
    ITEM_SPELL_EMBER("item.spell.ember"),
    ITEM_SPELL_EXEUNT("item.spell.exeunt"),
    ITEM_SPELL_FROST("item.spell.frost"),
    ITEM_SPELL_JOLT("item.spell.jolt"),
    ITEM_SPELL_RAYFIRE("item.spell.rayfire"),
    ITEM_SPELL_SCYTHEWIND("item.spell.scythewind"),
    ITEM_SPELL_SPIRIT_DRAIN("item.spell.spirit_drain"),
    ITEM_SPELL_TWINKLE("item.spell.twinkle"),
