    ...
    public static void onRegisterItemsEvent(@Nonnull final RegistryEvent.Register<Item> event)
    {
        ...
        registry.registerAll
            (
                ...
                LGRegistry.setup(new LGItemBase(EnumRarity.RARE, "tooltip.legendgear.fulgurite"), "fulgurite").setCreativeTab(LegendGear.TAB),
                ...
                LGRegistry.setup(new LGItemBase(EnumRarity.UNCOMMON, ""), "azurite").setCreativeTab(LegendGear.TAB),
